 ...
 * @hidden
 */
export declare function getSheetIndex(context: Workbook, sheet?: string | number): number;
/**
...
/** @hidden */
export declare function getSheet(context: Workbook, sheet?: string | number): SheetModel;
/**
 * @hidden
 */
