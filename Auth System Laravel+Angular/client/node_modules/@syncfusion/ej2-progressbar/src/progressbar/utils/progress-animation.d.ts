...
export declare class ProgressAnimation {
    ...
    doLinearIndeterminate(element: Element, progressWidth: number, thickness: number, progress: ProgressBar): void;
    /** Linear striped */
    doStripedAnimation(element: Element, progress: ProgressBar, value: number, delay?: boolean): void;
    /** Circular animation */
    ...
    doCircularIndeterminate(circularProgress: Element, progress: ProgressBar, start: number, end: number, x: number, y: number, radius: number, thickness: number): void;
